// Enables grpc liveness probes for k8s v1.24 or higher.
// From: https://github.com/grpc/grpc/blob/master/doc/health-checking.md
// NOTE: at the time of this implementation there is no readiness probe.
